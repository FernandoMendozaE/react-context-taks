import React, { useContext } from 'react' // ! importar useContext para poder usar el contexto
import { GlobalContext } from '../context/GlobalContext' // ! importando el contexto
import { Link } from 'react-router-dom' // ! importando Link para ruteo

const TaskList = () => {
  const { tasks, deleteTask, toggleTaskDone } = useContext(GlobalContext) // ? usando el contexto
